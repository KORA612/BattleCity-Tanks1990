...
#include "../../../BattleCity-Tanks1990-APfinal/Game.h"
...
Q_CONSTINIT static const qt_meta_stringdata_CLASSGameENDCLASS_t qt_meta_stringdata_CLASSGameENDCLASS = {
    {
        ...
        QT_MOC_LITERAL(5, 8),  // "openmenu"
        QT_MOC_LITERAL(14, 0),  // ""
        QT_MOC_LITERAL(15, 8),  // "GameOver"
        QT_MOC_LITERAL(24, 2),  // "ID"
        QT_MOC_LITERAL(27, 16)   // "SlotEndOfTheGame"
    },
    "Game",
    "openmenu",
    "",
...
void Game::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->SlotEndOfTheGame((*reinterpret_cast< std::add_pointer_t<int>>(_a[1]))); break;
        default: ;
        }
        ...
        {
            using _t = void (Game::*)();
            if (_t _q_method = &Game::openmenu; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
